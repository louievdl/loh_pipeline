#!/bin/bash
#qsub -cwd -l "h_rt=0:10:0,h_vmem=16G,tmem=16G -t 1-$TASK_COUNT -tc 10 -v GENOME=hg19,CHR_SUFFIX=nochr,RESULTS_BASE_DIR=/SAN/colcc/alex_work/samples_analysis,SAMPLE_METADATA=configuration/xxx.txt,PPLN_BASE_DIR=/SAN/colcc/alex_work/pipeline,CONDA_EXE=$CONDA_EXE job.sh
